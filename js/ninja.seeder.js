ninja.seeder = {
  ...
  showPool: function () {
    ...
    var percentSeeded =
      Math.round((ninja.seeder.seedCount / ninja.seeder.seedLimit) * 100) + '%';
    document.getElementById('mousemovelimit').innerHTML = percentSeeded;
    for (var wIndex in ninja.seeder.seederDependentWallets) {
      document.getElementById(
        ninja.seeder.seederDependentWallets[wIndex]
      ).innerHTML = percentSeeded;
    }
  },
  ...
  seedingOver: function () {
    ...
    // var culture =
    //   ninja.getQueryString()['culture'] == null
    //     ? 'en'
    //     : ninja.getQueryString()['culture'];
